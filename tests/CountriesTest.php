...
namespace Mohamed7sameer\CountriesLaravel\Tests\Service;

use Mohamed7sameer\CountriesLaravel\Package\Facade as Countries;
use Mohamed7sameer\CountriesLaravel\Tests\TestCase;
...
class CountriesTest extends TestCase
{
    ...
    {
        $crawler = $this->call('GET', 'mohamed7sameer/countries/flag/file/usa.svg');

        $this->assertEquals(false, $crawler->getContent());

        $crawler = $this->call('GET', 'mohamed7sameer/countries/flag/download/usa.svg');

        $this->assertEquals(false, $crawler->getContent());

        $crawler = $this->call('GET', 'mohamed7sameer/countries/flag/file/xxx.svg');
